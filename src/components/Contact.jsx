...
const Contact = () => {
    return (
        <div id='contacto' className='max-w-[1040px] m-auto md:pl-20 p-4 py-2 '>
            <h1 className='py-2 text-4xl font-bold text-center text-[#fff]'>
                Contacto
            </h1>
            <form className='mb-10' action="https://getform.io/f/dd0d9a8b-8290-4b9e-97ff-030cbc5bdd35" method='POST' encType='multipart/form-data'>
